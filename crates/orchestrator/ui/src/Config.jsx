...
const Link = ({ href, text = href }) => <a href={href} target="_blank" rel="noopener">{text}</a>;
...
const Panes = ({ config: c }) => (
  <div class="panels config">
    ...
    <div class="panel"><h3>Orchestrator</h3><Rows rows={[["version", c.version], ["listen", c.orchestrator.listen], ["public_url", c.orchestrator.public_url], ["database", c.orchestrator.database], ["heartbeat_timeout", c.orchestrator.heartbeat_timeout], ["log_retention", c.orchestrator.log_retention]]} /></div>
